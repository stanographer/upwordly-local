...
var DashboardComponent = function DashboardComponent(_ref) {
  ...
  var setShortName = function setShortName(val) {
    ...
    if (!val.match(re)) {
      setErrors([].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(errors), ['Your job shortname may only contain lower-case letters, numbers, hyphens, and underscores']));
    }
...
//# sourceMappingURL=2.13f987a6a144eb2c4aa3.hot-update.js.map