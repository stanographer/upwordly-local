...
var Color = function Color() {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_context_widget_context__WEBPACK_IMPORTED_MODULE_3__["default"].Consumer, {
    ...
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1__["Fragment"], {
      ...
      className: "text-center block border border-brightGreen rounded py-2 px-4 bg-blue-500 hover:bg-brightGreen text-teal-200",
      href: "#",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 18
      ...
      className: "text-center block border border-white rounded text-teal-200 hover:border-transparent hover:text-bg hover:bg-teal-200 py-2 px-4",
      href: "#",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 22
...
//# sourceMappingURL=6.c800ded43722250d88fc.hot-update.js.map