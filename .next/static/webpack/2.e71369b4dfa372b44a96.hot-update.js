...
var JobCreator = function JobCreator(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("form", {
    ...
    autoComplete: "off",
    spellCheck: false,
    className: !!errors || job.shortName === '' ? 'border-red-500 bg-red-100 shadow-lg appearance-none border rounded w-full py-2 px-3 focus:bg-red-2100 text-bg font-mono text-md' : 'shadow-lg appearance-none border rounded w-full py-2 px-3 focus:bg-blue-100 text-bg font-mono text-md"',
    id: "shortname",
    name: "shortname",
    type: "shortname",
...
//# sourceMappingURL=2.e71369b4dfa372b44a96.hot-update.js.map