...
var DashboardComponent = function DashboardComponent(_ref) {
  ...
  var setShortName = function setShortName(val) {
    ...
    if (!val.match(re)) {
      setErrors({
        shortName: 'Your job shortname may only contain lower-case letters, numbers, hyphens, and underscores'
      });
    }
...
//# sourceMappingURL=2.9cfabc8694e20d2f381c.hot-update.js.map