...
var Font = function Font() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_context_widget_context__WEBPACK_IMPORTED_MODULE_1__["default"].Consumer, {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], {
      ...
      className: "border rounded text-pink-200 border-pink-200 bg-bg2 border-bg2 hover:border-transparent hover:text-bg hover:bg-pink-200 hover:border-pink-200 text-lg mt-6 mx-2 px-3 py-2 font-apercu",
      type: "button",
      onClick: function onClick() {
...
//# sourceMappingURL=3.cd3985c4afa09f112f5c.hot-update.js.map