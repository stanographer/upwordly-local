...
var Nav = function Nav() {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("nav", {
    className: "flex items-center justify-center md:justify-between flex-wrap bg-bg px-2 py-6 md:p-6",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 26
    },
    ...
    className: " font-semibold sm:font-black text-xl tracking-tight md:content-center",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 31
    },
    ...
    className: " flex w-full flex-grow content-center justify-center lg:w-1/2 lg:content-left lg:justify-start tab",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 38
    },
...
//# sourceMappingURL=view.js.e628b0231b49ee6a811b.hot-update.js.map