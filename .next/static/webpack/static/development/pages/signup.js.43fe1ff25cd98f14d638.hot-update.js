...
var checkDupeEmail = function checkDupeEmail(email) {
  return _firebase__WEBPACK_IMPORTED_MODULE_0__["db"].ref('users').orderByChild('email').equalTo(email).on('value');
};
...
//# sourceMappingURL=signup.js.43fe1ff25cd98f14d638.hot-update.js.map