...
var Nav = function Nav() {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("nav", {
    ...
    className: " flex items-center px-3 py-2 border rounded bg-bg text-teal-200 border-teal-200 hover:text-white hover:border-white",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 34
    },
    ...
    __self: this
  }, "Menu"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("path", {
    ...
    className: " flex w-full flex-grow content-left justify-start md:w-1/2 md:justify-start",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 53
    },
...
//# sourceMappingURL=view.js.624a615dbd4d7d53c3b0.hot-update.js.map