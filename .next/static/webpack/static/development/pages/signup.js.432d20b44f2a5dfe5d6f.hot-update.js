...
var checkDupeEmail = function checkDupeEmail(email) {
  return _firebase__WEBPACK_IMPORTED_MODULE_0__["db"].ref.child('users').orderByChild('email').equalTo(email).on('value', function (snapshot) {
    return !snapshot.val();
  });
};
...
//# sourceMappingURL=signup.js.432d20b44f2a5dfe5d6f.hot-update.js.map