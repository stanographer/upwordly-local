...
var NavButton = function NavButton(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
    href: "#",
    onClick: onClick,
    className: " inline-block text-sm mx-2 px-4 py-2 leading-none border rounded text-teal-200 border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 lg:mt-0",
    __source: {
...
//# sourceMappingURL=view.js.bcdb79935c7add0d5e9d.hot-update.js.map