...
var NavButton = function NavButton(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
    href: "#",
    onClick: onClick,
    className: " inline-block text-sm mx-3 px-4 py-3 md:mt-1 lg:mt-0 leading-none border rounded text-teal-200 border-white hover:border-transparent hover:text-bg hover:bg-teal-200 ",
    __source: {
...
//# sourceMappingURL=view.js.6e525100e99ebce88ee4.hot-update.js.map