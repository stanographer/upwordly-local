    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6__["default"])(_this), "handleSubmit", function () {
      ...
      if (emailValid && fullNameValid && locationValid && passwordValid && tokenValid && usernameValid) {
        _src_firebase__WEBPACK_IMPORTED_MODULE_14__["auth"].doCreateUserWithEmailAndPassword(email, password).then(function (authUser) {
          _src_firebase__WEBPACK_IMPORTED_MODULE_14__["db"].doCreateUser(email, fullName, location, authUser.user.uid, payment, token, username);
        }).then(function () {
...
//# sourceMappingURL=signup.js.8ff68efc3a663fbc2e52.hot-update.js.map