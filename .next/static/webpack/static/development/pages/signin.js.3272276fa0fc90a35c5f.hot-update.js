...
var getAllJobsByUser = function getAllJobsByUser(uid, cb) {
  return _firebase__WEBPACK_IMPORTED_MODULE_0__["db"].ref("users/".concat(uid, "/jobs")).on('value', function (snapshot) {
    cb(snapshot.val());
  });
};
...
//# sourceMappingURL=signin.js.3272276fa0fc90a35c5f.hot-update.js.map