...
var checkDupeEmail = function checkDupeEmail(email) {
  return _firebase__WEBPACK_IMPORTED_MODULE_0__["db"].ref('users').orderByChild('email').equalTo(email).on();
};
...
//# sourceMappingURL=signup.js.a07593aed6ef5ec000c4.hot-update.js.map