...
var getAllJobsByUser = function getAllJobsByUser(user, cb) {
  _firebase__WEBPACK_IMPORTED_MODULE_0__["db"].ref('jobs').orderByChild('username').equalTo(user).on('value', function (snapshot) {
    cb(snapshot.val());
  })["catch"](function (err) {
    return err;
  });
...
//# sourceMappingURL=signin.js.e46c5fd7651e53b53661.hot-update.js.map