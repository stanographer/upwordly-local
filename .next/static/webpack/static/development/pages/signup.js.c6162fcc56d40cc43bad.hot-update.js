      ...
      if (emailValid && fullNameValid && locationValid && passwordValid && tokenValid && usernameValid) {
        _src_firebase__WEBPACK_IMPORTED_MODULE_14__["auth"].doCreateUserWithEmailAndPassword(email, password).then(function (authUser) {
          ...
          return _this.setState({
            errors: [].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_this.state.errors), [err])
          });
        }).then(function () {
...
//# sourceMappingURL=signup.js.c6162fcc56d40cc43bad.hot-update.js.map