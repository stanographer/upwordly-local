...
var checkDupeEmail = function checkDupeEmail(email) {
  return _firebase__WEBPACK_IMPORTED_MODULE_0__["db"].ref('users').orderByChild('email').equalTo(email);
};
...
//# sourceMappingURL=signup.js.687503ab9514685d94b1.hot-update.js.map