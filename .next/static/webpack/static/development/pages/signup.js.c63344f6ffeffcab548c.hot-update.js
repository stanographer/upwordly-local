...
/* harmony import */ var _routes__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../routes */ "./routes/index.js");
  ...
  function SignUp(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6__["default"])(_this), "handleSubmit", function (e) {
      ...
      if (emailValid && fullNameValid && locationValid && passwordValid && tokenValid && usernameValid) {
        _src_firebase__WEBPACK_IMPORTED_MODULE_14__["auth"].doCreateUserWithEmailAndPassword(email, password).then(function (authUser) {
          console.log(authUser);
          _src_firebase__WEBPACK_IMPORTED_MODULE_14__["db"].doCreateUser(email, fullName, location, authUser.user.uid, payment, token, username).then(function () {
            ...
            next_router__WEBPACK_IMPORTED_MODULE_12___default.a.push({
              pathname: _routes__WEBPACK_IMPORTED_MODULE_15__["DASHBOARD"],
              query: ''
            });
          }).catch(function (err) {
            return _this.setState({
              errors: [].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(_this.state.errors), [err])
            });
          });
        }).catch(function (err) {
          return _this.setState({
...
/* harmony default export */ __webpack_exports__["default"] = (Object(next_router__WEBPACK_IMPORTED_MODULE_12__["withRouter"])(SignUp));

/***/ })

})
//# sourceMappingURL=signup.js.c63344f6ffeffcab548c.hot-update.js.map