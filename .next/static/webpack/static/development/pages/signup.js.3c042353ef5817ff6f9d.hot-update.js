...
var checkDupeEmail = function checkDupeEmail(email) {
  return _firebase__WEBPACK_IMPORTED_MODULE_0__["db"].ref('users').orderByChild('email').equalTo(email).once('value', function (snapshot) {
    return snapshot.val();
  });
};
...
//# sourceMappingURL=signup.js.3c042353ef5817ff6f9d.hot-update.js.map