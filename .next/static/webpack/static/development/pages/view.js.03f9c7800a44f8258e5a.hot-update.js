...
var NavButton = function NavButton(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
    href: "#",
    onClick: onClick,
    className: " inline-block text-sm mt-2 mx-0 px-2 py-1 sm:px-4 sm:py-2 md:mx-3 md:mt-1 lg:mt-0 leading-none border rounded text-teal-200 border-white hover:border-transparent hover:text-bg hover:bg-teal-200 ",
    __source: {
...
//# sourceMappingURL=view.js.03f9c7800a44f8258e5a.hot-update.js.map