    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_9__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7__["default"])(_this), "validateStepTwo", function (email) {
      try {
        ...
        if (!re.test(String(email).trim().toLowerCase())) {
          ...
          console.log('dupe', _src_firebase__WEBPACK_IMPORTED_MODULE_15__["db"].checkDupeEmail(email)); // Testing to make sure that the email isn't already registered.
        } else if (_src_firebase__WEBPACK_IMPORTED_MODULE_15__["db"].checkDupeEmail(email)) {
          _this.setState({
...
//# sourceMappingURL=signup.js.3095021ccf600cf1c91d.hot-update.js.map