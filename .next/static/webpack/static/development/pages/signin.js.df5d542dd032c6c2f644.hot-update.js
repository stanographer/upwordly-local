...
var getAllJobsByUser = function getAllJobsByUser(uid, cb) {
  return _firebase__WEBPACK_IMPORTED_MODULE_0__["db"].ref("users/".concat(uid, "/jokbs")).on('value', function (snapshot) {
    cb(snapshot.val());
  });
};
...
//# sourceMappingURL=signin.js.df5d542dd032c6c2f644.hot-update.js.map