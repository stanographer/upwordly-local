...
var getAllJobsByUser = function getAllJobsByUser(user, cb) {
  return _firebase__WEBPACK_IMPORTED_MODULE_0__["db"].ref('jobs').orderByChild('username').on('value', function (snapshot) {
    cb(snapshot.val());
  });
};
...
//# sourceMappingURL=12.b8b918b5af7756e2e918.hot-update.js.map