...
var Color = function Color() {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_context_widget_context__WEBPACK_IMPORTED_MODULE_3__["default"].Consumer, {
    ...
    return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1__["Fragment"], {
      ...
      className: bgFg === 'fg' ? 'text-center block border border-brightGreen rounded py-2 px-4 bg-teal-200 text-bg' : 'text-center block border border-white rounded text-teal-200 hover:border-transparent hover:text-bg hover:bg-teal-200 py-4 px-4',
      href: "#",
      ...
      className: bgFg === 'bg' ? 'text-center block border border-brightGreen rounded py-2 px-4 bg-teal-200 text-bg' : 'text-center block border border-white rounded text-teal-200 hover:border-transparent hover:text-bg hover:bg-teal-200 py-4 px-4',
      href: "#",
      onClick: function onClick(e) {
        e.preventDefault();
        setBgFg('bg');
      ...
      className: bgFg === 'fg' ? 'px-3' : 'visually-hidden',
      __source: {
        fileName: _jsxFileName,
        lineNumber: 39
      },
      ...
      className: bgFg === 'bg' ? 'px-3' : 'visually-hidden',
      __source: {
        fileName: _jsxFileName,
        lineNumber: 48
      },
...
//# sourceMappingURL=6.3d9a26694aaee1c235ea.hot-update.js.map