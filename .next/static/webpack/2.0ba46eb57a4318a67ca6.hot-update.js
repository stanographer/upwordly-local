...
var JobCreator = function JobCreator(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("form", {
    ...
    autoComplete: "off",
    spellCheck: false,
    className: !!errors ? 'border-red-500 shadow-lg appearance-none border rounded w-full py-2 px-3 focus:bg-red-100 text-bg font-mono text-md' : 'shadow-lg appearance-none border rounded w-full py-2 px-3 focus:bg-blue-100 text-bg font-mono text-md"',
    id: "shortname",
    name: "shortname",
    type: "shortname",
...
//# sourceMappingURL=2.0ba46eb57a4318a67ca6.hot-update.js.map