...
var getAllJobsByUser = function getAllJobsByUser(user, cb) {
  return _firebase__WEBPACK_IMPORTED_MODULE_0__["db"].ref('users').orderByChild().on('value', function (snapshot) {
    cb(snapshot.val());
  });
};
...
//# sourceMappingURL=12.9ea067768c72876a7eda.hot-update.js.map