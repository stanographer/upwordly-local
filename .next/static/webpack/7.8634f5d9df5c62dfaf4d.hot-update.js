...
var Share = function Share() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_context_widget_context__WEBPACK_IMPORTED_MODULE_1__["default"].Consumer, {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], {
      ...
      className: "border rounded text-teal-200 bg-bg2 border-bg hover:border-transparent hover:text-bg hover:bg-teal-200 hover:border-teal-200 text-lg mt-2 mx-0 px-3 py-2 font-apercu",
      type: "button",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 11
...
//# sourceMappingURL=7.8634f5d9df5c62dfaf4d.hot-update.js.map