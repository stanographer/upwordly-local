...
var getAllJobsByUser = function getAllJobsByUser(user, cb) {
  return _firebase__WEBPACK_IMPORTED_MODULE_0__["db"].ref('jobs').orderByChild('username').equalTo(user).on('value', function (snapshot) {
    cb(snapshot.val());
  })["catch"](function (err) {
    return err;
  });
...
//# sourceMappingURL=12.169dbb21946f9821d95e.hot-update.js.map