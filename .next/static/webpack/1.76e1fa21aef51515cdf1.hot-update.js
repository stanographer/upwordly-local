...
var ModalSaveButton = function ModalSaveButton(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
    className: "block border rounded text-teal-200 border-teal-200 bg-bg2 border-bg2 hover:border-transparent hover:text-bg hover:bg-teal-200 hover:border-teal-200 text-lg mt-6 mx-2 px-3 py-2 font-apercu",
    type: "button",
...
//# sourceMappingURL=1.76e1fa21aef51515cdf1.hot-update.js.map