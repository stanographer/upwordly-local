...
var JobCreator = function JobCreator() {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    __self: this
  }, "Shortname (as it will appear in the link)"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
    autoFocus: true,
    autoComplete: "off",
    spellCheck: false,
    ...
    __self: this
  }, "Speakers"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
    autoFocus: true,
    autoComplete: "off",
    spellCheck: false,
    className: "shadow-lg appearance-none border rounded w-full py-2 px-3 focus:bg-blue-100 text-bg font-mono text-md",
    ...
    name: "speakers",
    type: "speakers",
    placeholder: "Christopher Hagan, Stanley Sakai",
    required: true,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 47
...
//# sourceMappingURL=8.1ee67fb4261abef96af0.hot-update.js.map