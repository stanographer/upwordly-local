              ...
              return (
                  <ReactFullpage.Wrapper>
                    ...
                    <div className="section flex">
                      <header
                          className="text-center mb-10 text-5xl font-bold italic text-bg bg-highlighter flex-shrink-0">
                        About Upword.ly
                      </header>
                        ...
                        <div className="w-full lg:w-1/2 p-2">
                          <div className="text-fg text-center p-2">
                            <p className='w-9/12 lg:w-7/12 text-left mx-auto my-5 text-md lg:text-lg'>
                              <span className="text-highlighter font-bold italic">Upword.ly</span> is a real-time
                                                                                                   transcription
                                                                                                   delivery tool and a
                                                                                                   content
                                                                                                   management system
                                                                                                   ...
                                                                                                   your CAT software via
                                                                                                   a small helper app,
                                                                                                   and start writing.
                            </p>
                            <p className='w-9/12 lg:w-7/12 text-left mx-auto my-5 text-md lg:text-lg'>
                              Since it is web-based, there's <span
                                className="font-bold italic text-green-200">no need</span> for your
                              consumers to install anything on their end. Distribute your live feed to anyone via a
                              personalized
                              URL and that's it!
                            </p>
                            <p className='w-9/12 lg:w-7/12 text-left mx-auto my-5 text-md lg:text-lg'>
                              ...
                              disseminate the transcript or to delete it. <span
                                className="font-bold italic text-green-200">Simple.</span>
                            </p>
                          </div>
                        </div>
