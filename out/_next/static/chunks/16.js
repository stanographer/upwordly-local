...
var commonjsGlobal = typeof globalThis !== 'undefined' ? globalThis :  true ? window : undefined;
...
var default_1$1 = /** @class */ (function (_super) {
    ...
    default_1.prototype.render = function () {
        ...
        return (Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])("li", { className: classes, ref: function (li) { return (_this.ref = li); }, style: this.props.style, onMouseDown: this.props.onMouseDown, onMouseOut: this.props.onMouseOut, onClick: this.onClick }, content));
    };
    return default_1;
}(react__WEBPACK_IMPORTED_MODULE_0__["PureComponent"]));
    ...
    default_1.prototype.render = function () {
        ...
        var classes = classnames('geosuggest__suggests', this.props.suggestsClassName, { 'geosuggest__suggests--hidden': this.isHidden() }, (_a = {},
            _a[this.props.hiddenClassName || ''] = this.props.hiddenClassName
                ...
                : null,
            _a));
        return (Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])("ul", { className: classes, style: this.props.style }, this.props.suggests.map(function (suggest) {
            var isActive = (_this.props.activeSuggest &&
                suggest.placeId === _this.props.activeSuggest.placeId) ||
                false;
            return (Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(default_1$1, { key: suggest.placeId, className: suggest.className || '', userInput: _this.props.userInput, isHighlightMatch: _this.props.isHighlightMatch, suggest: suggest, style: _this.props.suggestItemStyle, suggestItemClassName: _this.props.suggestItemClassName, isActive: isActive, activeClassName: _this.props.suggestItemActiveClassName, onMouseDown: _this.props.onSuggestMouseDown, onMouseOut: _this.props.onSuggestMouseOut, onSelect: _this.props.onSuggestSelect, renderSuggestItem: _this.props.renderSuggestItem }));
        })));
    };
    return default_1;
}(react__WEBPACK_IMPORTED_MODULE_0__["PureComponent"]));
...
var default_1$3 = /** @class */ (function (_super) {
    ...
    default_1$1.prototype.render = function () {
        ...
        var input = (Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(default_1, __assign({ className: this.props.inputClassName, ref: function (i) { return (_this.input = i); }, value: this.state.userInput, doNotSubmitOnEnter: !this.state.isSuggestsHidden, ignoreTab: this.props.ignoreTab, ignoreEnter: this.props.ignoreEnter, style: this.props.style && this.props.style.input, onChange: this.onInputChange, onFocus: this.onInputFocus, onBlur: this.onInputBlur, onKeyDown: this.props.onKeyDown, onKeyPress: this.props.onKeyPress, onNext: this.onNext, onPrev: this.onPrev, onSelect: this.onSelect, onEscape: this.hideSuggests }, attributes)));
        var suggestionsList = (Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(default_1$2, { isHidden: this.state.isSuggestsHidden, style: this.props.style && this.props.style.suggests, suggestItemStyle: this.props.style && this.props.style.suggestItem, userInput: this.state.userInput, isHighlightMatch: Boolean(this.props.highlightMatch), suggestsClassName: this.props.suggestsClassName, suggestItemClassName: this.props.suggestItemClassName, suggests: this.state.suggests, hiddenClassName: this.props.suggestsHiddenClassName, suggestItemActiveClassName: this.props.suggestItemActiveClassName, activeSuggest: this.state.activeSuggest, onSuggestNoResults: this.onSuggestNoResults, onSuggestMouseDown: this.onSuggestMouseDown, onSuggestMouseOut: this.onSuggestMouseOut, onSuggestSelect: this.selectSuggest, renderSuggestItem: this.props.renderSuggestItem }));
        return (Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", { className: classes },
            Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", { className: "geosuggest__input-wrapper" },
                shouldRenderLabel && (Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])("label", { className: "geosuggest__label", htmlFor: attributes.id }, this.props.label)),
                input),
...
/* harmony default export */ __webpack_exports__["default"] = (default_1$3);
